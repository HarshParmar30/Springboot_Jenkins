        ...
        stage('build') {
            ...
            steps {
                script{
                    ...
                    sh "docker build -t harshparmar080/spring-boot:${IMAGE_NAME} ."
        ...
        input{
            ...
            steps {
                ...
                withCredentials([usernamePassword(credentialsId: 'docker', usernameVariable: 'USERNAME', passwordVariable: 'PASSWORD')]){
                    ...
                    sh "docker push harshparmar080/spring-boot:${IMAGE_NAME}"
                }}
...
//                         sh "git remote set-url origin https://${USERNAME}:${PASSWORD}@github.com/harshparmar080/springboot_jenkins.git"
//                         sh 'git add .'
